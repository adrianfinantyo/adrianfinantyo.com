    ...
    <PageLayout>
      ...
      <VStack alignItems="flex-start" spacing="2rem">
        ...
        <Text fontSize={{ base: "lg", md: "xl" }}>
          Software engineer with focus on web and mobile development. Proficient in both frontend and backend
          development using MERN Stack, Ionic Capacitor, Cloud Computing with Digital Ocean, and Firebase. Keen to
          learn, excellent with time management, problem solving skill, work collaboratively, and consistently meet
          deadlines. Strong engineering professional with bachelor’s degree focusing on Informatics from{" "}
